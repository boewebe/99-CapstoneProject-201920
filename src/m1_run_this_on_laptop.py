...
def main():
    ...
    # -------------------------------------------------------------------------
    root = tkinter.Tk()
    root.title("CSSE 120 Capstone Project - Brendan Boewe")
    ...
    # -------------------------------------------------------------------------
    teleop_frame, drive_system_frame, drive_system_2_frame, arm_frame, control_frame, sound_system_frame = get_shared_frames(main_frame, mqtt_sender)
...
def grid_frames(teleop_frame, drive_system_frame, drive_system_2_frame, arm_frame, control_frame, sound_system_frame):
    ...
    drive_system_2_frame.grid(row=0, column=1)
