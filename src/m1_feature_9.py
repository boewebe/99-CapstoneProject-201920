...
def test_led_pickup(initial_led_rate, rate_of_led_increase):
    ...
    while True:
        ...
        pause_time = 3 *(percent_distance) / (((initial_led_rate) + ((rate_of_led_increase) * (1 - percent_distance))))
    ...
    robot.arm_and_claw.calibrate_arm()  # this is for testing so it resets
